...
async function initialize(opts) {
    ...
    const resolveRoutes = (0, _resolveroutes.getResolveRoutes)(fsChecker, config, opts, renderServer.instance, renderServerOpts, devInstance == null ? void 0 : devInstance.ensureMiddleware);
