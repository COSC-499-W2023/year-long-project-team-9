...
function getResolveRoutes(fsChecker, config, opts, renderServer, renderServerOpts, ensureMiddleware) {
    ...
    async function resolveRoutes({ req, res, isUpgradeReq, invokedOutputs }) {
        ...
        if (urlNoQuery == null ? void 0 : urlNoQuery.match(/(\\|\/\/)/)) {
            parsedUrl = _url.default.parse((0, _utils1.normalizeRepeatedSlashes)(req.url), true);
            return {
                parsedUrl,
                resHeaders,
                finished: true,
            ...
            if (params) {
                ...
                if (!opts.minimalMode && route.name === "middleware") {
                    ...
                    (match == null ? void 0 : match(parsedUrl.pathname, req, parsedUrl.query)) && (!ensureMiddleware || await (ensureMiddleware == null ? void 0 : ensureMiddleware().then(()=>true).catch(()=>false)))) {
                        ...
                        const middlewareHeaders = (0, _utils.toNodeOutgoingHttpHeaders)(middlewareRes.headers);
                ...
                if (("statusCode" in route || "permanent" in route) && route.destination) {
                    ...
                    parsedDestination.pathname = (0, _utils1.normalizeRepeatedSlashes)(parsedDestination.pathname);
                    return {
                        finished: true,
