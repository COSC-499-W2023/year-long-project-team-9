...
async function writeConfigurationDefaults(ts, tsConfigPath, isFirstTimeSetup, isAppDirEnabled, distDir, hasPagesDir) {
    ...
    for (const optionKey of Object.keys(desiredCompilerOptions)){
        ...
        if ("suggested" in check) {
            if (!(optionKey in tsOptions)) {
                ...
                suggestedActions.push((0, _picocolors.cyan)(optionKey) + " was set to " + (0, _picocolors.bold)(check.suggested));
            }
    ...
    if (!("include" in rawConfig)) {
        ...
        suggestedActions.push((0, _picocolors.cyan)("include") + " was set to " + (0, _picocolors.bold)(isAppDirEnabled ? `['next-env.d.ts', '${nextAppTypes}', '**/*.ts', '**/*.tsx']` : `['next-env.d.ts', '**/*.ts', '**/*.tsx']`));
    ...
    _log.info(`We detected TypeScript in your project and reconfigured your ${(0, _picocolors.cyan)("tsconfig.json")} file for you. Strict-mode is set to ${(0, _picocolors.cyan)("false")} by default.`);
