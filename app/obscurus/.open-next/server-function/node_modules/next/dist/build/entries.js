...
function createPagesMapping({ isDev, pageExtensions, pagePaths, pagesType, pagesDir }) {
    ...
    const pages = pagePaths.reduce((result, pagePath)=>{
        ...
        if (pageKey in result) {
            (0, _log.warn)(`Duplicate page detected. ${(0, _picocolors.cyan)((0, _path.join)("pages", previousPages[pageKey]))} and ${(0, _picocolors.cyan)((0, _path.join)("pages", pagePath))} both resolve to ${(0, _picocolors.cyan)(pageKey)}.`);
        } else {
