...
async function webpackBuildWithWorker() {
    ...
    for (const compilerName of ORDERED_COMPILER_NAMES){
        var _curResult_serializedPagesManifestEntries, _curResult_serializedPagesManifestEntries1, _curResult_serializedPagesManifestEntries2, _curResult_serializedPagesManifestEntries3, _curResult_buildTraceContext;
        ...
        if ((_curResult_buildTraceContext = curResult.buildTraceContext) == null ? void 0 : _curResult_buildTraceContext.entriesTrace) {
            ...
            if (entryNameMap) {
                ...
                combinedResult.buildTraceContext.entriesTrace.entryNameMap = new Map(entryNameMap);
            }
            if ((_curResult_buildTraceContext1 = curResult.buildTraceContext) == null ? void 0 : _curResult_buildTraceContext1.chunksTrace) {
                ...
                if (entryNameFilesMap) {
                    ...
                    combinedResult.buildTraceContext.chunksTrace.entryNameFilesMap = new Map(entryNameFilesMap);
                }
            }
        }
    }
