...
async function collectBuildTraces({ dir, config, distDir, pageKeys, pageInfos, staticPages, nextBuildSpan, hasSsrAmpPages, buildTraceContext, outputFileTracingRoot }) {
        ...
        if (!(bindings == null ? void 0 : bindings.isWasm) && typeof bindings.turbo.startTrace === "function") {
            ...
            if (entriesTrace) {
                ...
                if (filesTracedFromEntries.length) {
                    ...
                    const [[, entryName]] = Array.from(entryNameMap.entries()).filter(([k])=>k.startsWith(buildTraceContextAppDir));
    ...
    await nextBuildSpan.traceChild("node-file-trace-build").traceAsyncFn(async ()=>{
        ...
        if (config.experimental.turbotrace) {
            ...
            var _buildTraceContext_chunksTrace, _buildTraceContext_chunksTrace1;
            const chunksToTrace = [
            ...
            for (const [entries, tracedFiles] of [
                ...
                for (const file of entries){
                    ...
                    for (const curFile of curFiles || []){
                        ...
                        if (!(0, _micromatch.isMatch)(filePath, "**/next/dist/pages/**/*", {
                            dot: true,
                            contains: true
                        })) {
            ...
            await Promise.all([
                ...(buildTraceContext == null ? void 0 : (_buildTraceContext_chunksTrace1 = buildTraceContext.chunksTrace) == null ? void 0 : _buildTraceContext_chunksTrace1.entryNameFilesMap.entries()) || new Map()
