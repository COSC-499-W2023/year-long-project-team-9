...
async function printTreeView(lists, pageInfos, { distPath, buildId, pagesDir, pageExtensions, buildManifest, appBuildManifest, middlewareManifest, useStaticPages404, gzipSize = true }) {
    ...
    const getPrettySize = (_size)=>{
        ...
        // green for 0-130kb
        if (_size < 130 * 1000) return (0, _picocolors.green)(size);
        // yellow for 130-170kb
        if (_size < 170 * 1000) return (0, _picocolors.yellow)(size);
        // red for >= 170kb
        return (0, _picocolors.red)((0, _picocolors.bold)(size));
    };
    ...
    print((0, _texttable.default)([
        ...
        usedSymbols.has("λ") && [
            "λ",
            "(Server)",
            `server-side renders at runtime (uses ${(0, _picocolors.cyan)("getInitialProps")} or ${(0, _picocolors.cyan)("getServerSideProps")})`
        ],
        usedSymbols.has("○") && [
            "○",
            "(Static)",
        ...
        usedSymbols.has("●") && [
            "●",
            "(SSG)",
            `automatically generated as static HTML + JSON (uses ${(0, _picocolors.cyan)("getStaticProps")})`
        ],
        usedSymbols.has("ISR") && [
            "",
            "(ISR)",
