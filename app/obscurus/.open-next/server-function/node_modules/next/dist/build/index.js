            ...
            if (!isCompile && (combinedPages.length > 0 || useStaticPages404 || useDefaultStatic500 || isAppDirEnabled)) {
                ...
                await staticGenerationSpan.traceAsyncFn(async ()=>{
                    ...
                    const exportOptions = {
                        ...
                        exportAppPageWorker: appStaticWorkers == null ? void 0 : appStaticWorkers.exportPage.bind(appStaticWorkers),
                        exportPageWorker: pagesStaticWorkers.exportPage.bind(pagesStaticWorkers),
                        endWorker: async ()=>{
