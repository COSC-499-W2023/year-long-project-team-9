...
class RekognitionVideoFaceBlurringCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        startFaceDetectFunction = lambda_.Function(
            ...
            memory_size=512,
            code=lambda_.Code.from_asset('./lambdas/rekopoc-start-face-detect'),
        ...
        checkStatusFunction = lambda_.Function(
            ...
            timeout=Duration.seconds(600),
            memory_size=512,
            code=lambda_.Code.from_asset('./lambdas/rekopoc-check-status'),
            handler="lambda_function.lambda_handler",
            runtime=lambda_.Runtime.PYTHON_3_7
        )
        ...
        getTimestampsFunction = lambda_.Function(
            ...
            timeout=Duration.seconds(600),
            memory_size=512,
            code=lambda_.Code.from_asset('./lambdas/rekopoc-get-timestamps-faces'),
            handler="lambda_function.lambda_handler",
            runtime=lambda_.Runtime.PYTHON_3_7
        )
        ...
        blurFacesFunction = lambda_.DockerImageFunction(
            ...
            timeout=Duration.seconds(600),
            memory_size=2048,
            code=lambda_.DockerImageCode.from_image_asset("./lambdas/rekopoc-apply-faces-to-video-docker")
        )
