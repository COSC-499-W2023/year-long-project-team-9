          ...
          <Dialog open={showSignInDialog} onOpenChange={setShowSignInDialog}>
            ...
            <DialogContent className="sm:max-w-[300px]">
              ...
              <div className="flex flex-col w-full items-center">
                ...
                <div id="emailLogin" className="grid gap-1.5 pb-2">
                  <Input placeholder="name@example.ca" className="pb-2"></Input>
                  <Input placeholder="Password"></Input>
                  <Button className="w-full">
                    <span>Log in with Email</span>
                  </Button>
                  <span className="bg-background px-2 text-muted-foreground text-xs justify-self-center">
                    Forgot your password?
                  </span>
                </div>
                <hr className="w-3/4 bg-gray-500" />
                <div id="signUpConnector" className="w-3/4 text-center pt-1">
