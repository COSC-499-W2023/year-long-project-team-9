  ...
  const Index = ({ url }: { url: string }) => {
    ...
    const determineNextButtonDisabled = () => {
      // Condition for the last item
      if (current === count) return true;
    
      // Condition specific to the second item and file not being selected
    ...
    return (
      <NestedLayout pos={1}>
        ...
        <Carousel setApi={setApi} className="w-full max-w-lg" plugins={[
          // Autoplay({
          //   delay: 2000,
          // }),
