    ...
    <div className="grid grid-cols-2 gap-40 justify-items-center max-w-fit w-full">
      <div className="grid grid-rows-3 gap-1 items-center ">
        ...
        <div className="grid grid-cols-2">
          <Tabs defaultValue="blurred">
            <TabsList>
              <TabsTrigger value="blurred" onClick={toggleBlur}>Blurred</TabsTrigger>
              <TabsTrigger value="notBlurred" onClick={toggleBlur}>Not Blurred</TabsTrigger>
            </TabsList>
            <TabsContent value="blurred"></TabsContent>
            <TabsContent value="notBlurred"></TabsContent>
          </Tabs>
        </div>
      </div>
      <div className="min-h-full relative justify-self-end">
        ...
        >
          ...
          />
          <path
            className={`stroke-slate-900 fill-white ${isBlurred ? 'opacity-0' : 'opacity-100'} transition-opacity duration-500 ease-in-out`}
